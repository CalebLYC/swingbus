 ...
 * @author Caleb Lyc
 */
public class EditBus extends JFrame {

    private entities.Bus busToEdit;
    ...
    public EditBus(entities.Bus bus) {
        busToEdit = bus;
        ...
        immaField.setText(busToEdit.getImmatriculation());
        maxField.setText(busToEdit.getMaximalPlaces().toString());
        marqueField.setText(busToEdit.getMarque());
        modelField.setText(busToEdit.getModel());
        yearField.setText(busToEdit.getYear().toString());
    ...
    private void displayDialog() {
        ...
        try {
            entities.Bus bus = new entities.Bus(busToEdit.getId(), numeroBus, max, marque, modele, annee);
            service.modifier(bus);
            StringBuilder sb = new StringBuilder();
            sb.append("Bus modifié avec succès: Bus de numéro");
            sb.append(numeroBus);
